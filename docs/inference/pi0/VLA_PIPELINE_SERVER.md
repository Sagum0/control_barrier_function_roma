...
[`VLA_PIPELINE_PARAMETERS.md`](../../../config/inference/pi0/VLA_PIPELINE_PARAMETERS.md)에 있다.
...
`piper_vla.inference.transports.vla_pipeline.sync_client`를 실행한다. launcher가 `lerobot-060` Python으로 자동
