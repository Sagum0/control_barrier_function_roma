...
from piper_vla.training.pi0 import settings as training_settings
...
class TrainingLayoutTest(unittest.TestCase):
    ...
    def test_canonical_workspace_paths_exist(self) -> None:
        ...
        expected_paths = (
            "src/piper_vla/training/pi0/trainer.py",
            "src/piper_vla/inference/pi0/policy_server.py",
            "scripts/training/pi0/train_from_config.py",
            "scripts/inference/pi0/serve_policy.py",
            "config/training/pi0/piper_lora.yaml",
            "config/inference/pi0/piper_inference.yaml",
        )
