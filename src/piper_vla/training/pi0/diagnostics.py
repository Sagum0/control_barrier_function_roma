...
from piper_vla.training.pi0.data import TrainingBatch, next_training_batch
from piper_vla.training.pi0.settings import (
...
if TYPE_CHECKING:
    from piper_vla.training.pi0.trainer import TrainingRuntime
...
def run_training_loop_with_diagnostics(
    ...
    *,
    ...
    from piper_vla.training.pi0 import trainer as training
