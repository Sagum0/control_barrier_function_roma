"""π0.5 장기 학습의 loss, 처리시간, 메모리, checkpoint 진단을 JSONL로 기록한다."""
...
from piper_vla.training.pi05.data import TrainingBatch, next_training_batch
...
if TYPE_CHECKING:
    from piper_vla.training.pi05.trainer import TrainingRuntime
...
def run_training_loop_with_diagnostics(
    ...
    *,
    ...
    from piper_vla.training.pi05 import trainer as training
