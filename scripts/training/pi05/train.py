#!/usr/bin/env python3
"""워크스페이스의 OpenPI와 Piper π0.5 학습 CLI를 연결한다."""
...
def main(argv: Sequence[str] | None = None) -> int:
    """workspace Python과 환경을 준비한 뒤 실제 Piper π0.5 학습 명령을 실행한다."""
    ...
    from piper_vla.training.pi05.trainer import main as training_main
