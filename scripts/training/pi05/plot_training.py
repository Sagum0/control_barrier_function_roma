#!/usr/bin/env python3
"""π0.5 JSONL 진단 로그를 추가 dependency 없이 SVG 그래프로 변환한다."""
...
def build_argument_parser() -> argparse.ArgumentParser:
    ...
    parser = argparse.ArgumentParser(description="π0.5 JSONL 진단 로그를 SVG로 변환합니다.")
...
def main(argv: Sequence[str] | None = None) -> int:
    ...
    run_dir = runs_root / PIPER_PI05_CONFIG_NAME / run_name
    ...
    output_path.write_text(
        render_diagnostics_svg(records, f"π0.5 diagnostics · {run_name}"),
        encoding="utf-8",
    )
