...
CONFIG_WRAPPER_PATH = WORKSPACE_ROOT / "scripts" / "training" / "pi0" / "train_from_config.py"

# OpenPI commit·cache·Python path 검증을 재사용할 기존 bootstrap이다.
TRAIN_BOOTSTRAP_PATH = WORKSPACE_ROOT / "scripts" / "training" / "pi0" / "train.py"
...
def main(argv: Sequence[str] | None = None) -> int:
    ...
    from piper_vla.training.pi0.trainer import main as training_main
