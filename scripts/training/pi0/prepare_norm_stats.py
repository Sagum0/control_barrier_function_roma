...
def main(argv: Sequence[str] | None = None) -> int:
    ...
    from piper_vla.common.dataset_v3 import PiperV3Dataset, STATE_NAMES
    from piper_vla.training.pi0.norm_stats import (
        DEFAULT_STATS_BATCH_FRAMES,
        compute_pi0_norm_stats,
        install_pi0_norm_stats,
    )
    from piper_vla.training.pi0.settings import LOCKED_MODEL_CONTRACT, load_pi0_settings
